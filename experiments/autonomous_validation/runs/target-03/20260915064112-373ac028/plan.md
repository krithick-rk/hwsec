...
**Analysis ID**: `20260915064112-373ac028`  
...
**Creation Date**: 2026-09-15T06:41:17.495Z  
...
> `hwsec proceed 20260915064112-373ac028`
...
- **semgrep** (`sast_pattern_scan`): Semgrep CLI not found in PATH or WSL
- **codeql** (`deep_dataflow, taint_tracking`): CodeQL CLI not detected in system PATH or WSL
- **joern** (`graph_dataflow, code_property_graph`): Joern CLI not detected in PATH or WSL (/home/intern/bin/joern/joern-cli)

---

## 3. Planned Execution Pipeline
```text
discovery -> sast_pattern_scan -> suspicion_scoring -> hypothesis_formulation -> artifact_verification -> correlation -> report_generation
```

- **Planned Capabilities**: sast_pattern_scan
