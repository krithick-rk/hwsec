...
**Audit Identifier**: `AUDIT-20260908102731-d7f50f`  
**Profile**: `FULL`  
**Execution Date**: 2026-09-08T10:27:42.993Z  
**Platform**: win32 (10.0.22631) x64 | Node v24.20.0  
**Readiness Score**: **9.2 / 10.0**  
...
**Security Gate Status**: BLOCKED: 1 High severity security failure(s) detected.

- **Total Adversarial Invariants Evaluated**: 47
- **Invariants Passed**: 46
- **Invariants Failed**: 1
- **Execution Duration**: 11183ms
...
| **RAG Integrity** | **0 / 10** | FAIL | Vector memory isolation, semantic retrieval |
...
## High Findings
### [HIGH] Qdrant: Vector Daemon Online on Port 6333
- **Suite**: `Qdrant Vector Memory & RAG Isolation Integration Suite`
...
| SymbiYosysTool: Malicious Filename & Top Module Escaping in .sby Generator | EXECUTION_SECURITY | ADVERSARIAL TEST | EMPIRICALLY VERIFIED | ✅ PASS |
...
| Qdrant: Vector Daemon Online on Port 6333 | RAG_INTEGRITY | INTEGRATION TEST | EMPIRICALLY VERIFIED | ❌ FAIL |
...
| Real Tool Validation: Yosys RTL Synthesis & Formal Engine | TOOL_INTEGRATION | REAL TOOL TEST | EMPIRICALLY VERIFIED | ✅ PASS |
